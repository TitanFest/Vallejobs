...
const Dashboard = () => {
  ...
  const handleToggleEstado = async (oferta) => {
    try {
      ...
      setMisOfertas(prev => prev.map(o => o.id === oferta.id ? res.data : o));
    } catch (err) {
    ...
    <div className="dashboard-wrapper">
      ...
      <div className="dashboard-container">
        ...
        <div className="dashboard-header">
          ...
          <button className="dashboard-new-job-btn" onClick={() => navigate('/CreateJob')}>
        ...
        <div className="dashboard-cards">
          <div className="dashboard-card">
            <div className="card-icon purple"><FaBriefcase /></div>
          ...
          <div className="dashboard-card">
            <div className="card-icon yellow"><FaClock /></div>
            <div className="card-info">
          ...
          <div className="dashboard-card">
            <div className="card-icon red"><FaTimesCircle /></div>
            <div className="card-info">
          ...
          <div className="dashboard-section">
            ...
            {tab === 'postulaciones' && (
              postulaciones.length === 0 ? (
                <p className="empty-msg">No te has postulado a ninguna oferta aún.</p>
              ) : (
            ...
            {tab === 'ofertas' && (
              misOfertas.length === 0 ? (
                <p className="empty-msg">No has publicado ninguna oferta aún. <button className="link-btn" onClick={() => navigate('/CreateJob')}>Publicar ahora</button></p>
              ) : (
                <table className="dashboard-table">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    {misOfertas.map(o => (
                      <tr key={o.id}>
                        ...
                        <td>
                          <span className={`estado-badge ${o.estado ? 'aceptado' : 'rechazado'}`}>
                        ...
                        <td className="acciones-cell">
                          ...
                          <button className="delete-btn" onClick={() => handleEliminarOferta(o.id)}
                            title="Eliminar">
                            <FaTrash />
                          </button>
                        </td>
