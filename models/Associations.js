...
OfertasTrabajo.belongsTo(Categoria, { foreignKey: 'categoriaId', as: 'categoria' });
...
OfertasTrabajo.hasMany(Postulacion, { foreignKey: 'ofertaId', as: 'postulaciones' });
...
User.belongsToMany(OfertasTrabajo, { through: Postulacion, foreignKey: 'userId', as: 'ofertasPostuladas' });
OfertasTrabajo.belongsToMany(User, { through: Postulacion, foreignKey: 'ofertaId', as: 'postulantes' });
